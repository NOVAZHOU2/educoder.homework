...
master = pd.read_csv('pandas_5/Training_Master.csv', encoding='gbk')
...
user = pd.read_csv('pandas_5/Training_Userupdate.csv', encoding='gbk')
...
log = pd.read_csv('pandas_5/Training_LogInfo.csv', encoding='gbk')
